...
if __name__ == "__main__":
    ...
    for date_range in date_ranges:
        ...
        df1 = pd.read_parquet(DATA_DIR / "intermediate" / f"data_{date_range}_L1filter.parquet")
        df2 = pd.read_parquet(DATA_DIR / "intermediate" / f"data_{date_range}_L2filter.parquet")
